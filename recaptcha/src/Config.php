...
class Config {
	...
	private const DEFAULTS = [
		...
		'v3_site_key'                   => '',
		'v3_secret_key'                 => '',
		'checkbox_size'                 => 'normal',
		'checkbox_add_css'              => true,
		'load_analytics_footer_script'  => true,
		'loggedin_hide'                 => true,
		'verify_origin'                 => false,
		'submit_remote_ip'              => true,
		'submit_user_agent'             => false,
		'submit_headers'                => false,
		'submit_request_uri'            => false,
		'submit_user_id'                => false,
		'submit_user_login'             => false,
		'submit_user_email'             => false,
		'submit_user_registered'        => false,
		'enabled_forms'                 => [],
		'action_login'                  => 'login',
		'action_registration'           => 'register',
		'action_ms_user_signup'         => 'ms_user_signup',
		'action_lost_password'          => 'lost_password',
		'action_reset_password'         => 'reset_password',
		'action_comment'                => 'comment',
		'threshold_login'               => 0.5,
		'threshold_registration'        => 0.5,
		'threshold_ms_user_signup'      => 0.5,
